...
import com.league.dal.common.domain.ColumnDO;
import com.league.dal.common.domain.TableDO;
        ...
        for (String template : templates) {
            ...
            try {
                ...
                zip.putNextEntry(new ZipEntry(getFileName(template, tableDO.getClassname(), tableDO.getClassName(),
                                                          config.getString("package").substring(config.getString("package").lastIndexOf(".")
                                                                                                + 1))));
